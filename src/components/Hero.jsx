...
const getRandomRotation = () => {
  return Math.random() * 60 - 30; // Generates a random number between -30 and 30
};
...
const Hero = React.forwardRef(({ setLampToggleApp }, ref) => {
  ...
  const disseminateTags = () => {
    const nonOverlappingPositions = () => {
      const positions = [];
      const minDistance = 50; // Minimum distance between tags in pixels
