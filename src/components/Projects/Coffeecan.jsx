    ...
    <div class='fixed inset-0 z-30 mx:auto bg-[#efefef] flex justify-center items-center h-screen w-screen overflow-y-auto'>
      <div class='bg-[#efefef] w-full h-full relative flex flex-col justify-between p-8'>
        <div className='header'>
          <h1 class='garet-book text-4xl font-bold mb-2 pl-12'>
        ...
        <div class='flex flex-wrap'>
          <button onClick={onClose} className='garet-book absolute top-4 right-4'>
          ...
          <div class='w-full md:w-1/3 px-12 mb-8 md:mb-0'>
            ...
            <p class='garet-book mb-12'>{t('portfolio.coffeecan.feedbackdesignP')}</p>
          ...
          <div class='w-full md:w-2/3 px-12'>
            <h2 class='garet-book text-2xl mb-14'>{t('portfolio.coffeecan.storyT')}</h2>
            <p class='garet-book mb-12 max-w-[800px]'>{t('portfolio.coffeecan.storyP')}</p>
